...
import { styles } from './DetallesCuidadores.styles';

const DetallesCuidadores = ({ 
  visible, 
  cuidador, 
  onClose,
  onResenas,
  ...
  const rating = cuidador?.rating || 0;
  ...
  const handleResenas = () => onResenas?.(cuidador);
  const handleConectar = () => onConectar?.(cuidador);
  
  // Verificamos si hay cuidador después de declarar todos los hooks y funciones
    ...
    <Modal {...modalProps}>
      <View style={styles.contentContainer}>
        ...
        >
          ...
          {/* Descripción */}
          <SectionContainer title="Sobre el cuidador">
          ...
          <SectionContainer title="Pasos a seguir:">
            <StepItem 
              number="1" 
              text="Envía tu solicitud de conexión al prestador." 
            />
            <StepItem 
              number="2" 
              text="Coordina el horario y los detalles del servicio a través del chat." 
            />
            <StepItem 
              number="3" 
              text="Realiza el pago de manera segura desde la app." 
            />
            <StepItem 
              number="4" 
...
export default DetallesCuidadores;